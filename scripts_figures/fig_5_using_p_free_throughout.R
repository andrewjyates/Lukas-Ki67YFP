...
#3b. Flow model (p free)
load("../fitting/DataObjects/flow_sim_frac_pfree.Rdata")
...
pdf("../figures/fig_5_p_nonzero.pdf", width=plotwidth, height=plotwidth/1.2)
print(parameter_plot)
dev.off()

pdf("../../Manuscript/PaperFigures/Figure-5-pnonzero.pdf", width=plotwidth, height=plotwidth/1.2)
print(parameter_plot)
dev.off()
